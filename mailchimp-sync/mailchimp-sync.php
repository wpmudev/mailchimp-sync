			...
			?>
				...
				<?php 
					if ( is_multisite() ) {
						...
						?><form method="post" action="options-general.php?page=mailchimp&action=import-process"><?php
					}
				?>
					<table class="form-table">
	        			<tr class="form-field form-required">
					...
					<p class="submit">
						<input type="submit" name="Submit" class="button-primary" value="<?php _e('Import', 'mailchimp') ?>" />
					</p>
				</form>
				<?php
	            }
